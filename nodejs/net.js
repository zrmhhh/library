...
net.createServer(function (client) {
    client.on('data', function (data) {
        ...
        client.on("data", function (data) { console.log(`client: client ===>>> ${data.toString()}`); server.write(data); });
        server.on("data", function (data) { console.log(`client: server ===>>> ${data.toString()}`); client.write(data); });
    });
}).listen(1111);
